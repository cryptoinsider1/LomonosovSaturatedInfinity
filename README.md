...
> Репозиторий — благодарность Михаилу Васильевичу Ломоносову, чьё имя символизирует путь человека, изменившего мир,  
...
то есть изменяется лишь глобальная фаза $e^{i\phi}$, а наблюдаемые величины остаются неизменными.
...
# Исходное состояние (пример — базисный вектор)
